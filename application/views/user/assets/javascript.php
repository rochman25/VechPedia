<script src="<?=base_url()?>assets/user/js/vendor/jquery-2.2.4.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.<?=base_url()?>assets/user/js/1.11.0/umd/popper.min.js" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4" crossorigin="anonymous"></script>
...
<script src="<?=base_url()?>assets/user/js/countdown.js"></script>
...
<script src="<?=base_url()?>assets/user/js/gmaps.min.js"></script>
